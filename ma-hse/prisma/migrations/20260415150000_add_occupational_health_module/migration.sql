...
CREATE UNIQUE INDEX "OccupationalHealthWorker_plantId_employeeNo_key" ON "OccupationalHealthWorker"("plantId", "employeeNo");
CREATE INDEX "OccupationalHealthWorker_plantId_isActive_examDate_idx" ON "OccupationalHealthWorker"("plantId", "isActive", "examDate");
