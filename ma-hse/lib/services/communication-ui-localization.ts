...
const PT_COMMUNICATION_UI: PartialDeep<CommunicationUi> = {
  ...
  validationQueue: {
    ...
    allTypes: "Todos os tipos",
    allReporters: "Todos os comunicantes",
    reporter: "Comunicante",
    dateFrom: "De",
    dateTo: "Até",
    clearFilters: "Limpar filtros",
    invalidDateRange: "A data inicial tem de ser anterior ou igual à data final.",
    noRows: "Não foram encontradas comunicações para os filtros selecionados.",
    department: "Departamento",
    location: "Local",
    date: "Data",
    openEdit: "Abrir / editar",
  ...
  detailEditor: {
    ...
    pendingValidationLinkingBlocked: "Esta comunicacao tem de ser validada antes de associar acoes ou S-EWO.",
    saving: "A guardar...",
