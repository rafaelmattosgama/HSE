...
type ReportText = {
  ...
  typeNearMiss: string;
  typeFirstAid: string;
  typeFiveSImprovement: string;
  typeImprovementSuggestion: string;
  improvementSubtype: string;
  selectImprovementSubtype: string;
  fiveSAreaImprovement: string;
  fiveSDisorganization: string;
  improvementSafety: string;
  improvementHealth: string;
  improvementEnvironment: string;
  dateTime: string;
...
const REPORT_TEXTS: Record<SupportedReportLocale, ReportText> = {
  en: {
    ...
    typeFiveSImprovement: "5S Improvement",
    typeImprovementSuggestion: "Improvement suggestion",
    improvementSubtype: "Subtype",
    selectImprovementSubtype: "Select subtype",
    fiveSAreaImprovement: "Area improvement",
    fiveSDisorganization: "Disorganization",
    improvementSafety: "Safety",
    improvementHealth: "Health",
    improvementEnvironment: "Environment",
  ...
  pt: {
    ...
    fiveSAreaImprovement: "Melhoria de área",
    fiveSDisorganization: "Desorganização",
    improvementSafety: "Segurança",
    improvementHealth: "Saúde",
    improvementEnvironment: "Ambiente",
  ...
  it: {
    ...
    typeFiveSImprovement: "Miglioramento 5S",
    typeImprovementSuggestion: "Suggerimento di miglioramento",
    improvementSubtype: "Sottotipo",
    selectImprovementSubtype: "Seleziona sottotipo",
    fiveSAreaImprovement: "Miglioramento area",
    fiveSDisorganization: "Disorganizzazione",
    improvementSafety: "Sicurezza",
    improvementHealth: "Salute",
    improvementEnvironment: "Ambiente",
    dateTime: "Data e ora",
  ...
  pl: {
    ...
    typeFiveSImprovement: "Usprawnienie 5S",
    typeImprovementSuggestion: "Sugestia usprawnienia",
    improvementSubtype: "Podtyp",
    selectImprovementSubtype: "Wybierz podtyp",
    fiveSAreaImprovement: "Usprawnienie obszaru",
    fiveSDisorganization: "Dezorganizacja",
    improvementSafety: "Bezpieczenstwo",
    improvementHealth: "Zdrowie",
    improvementEnvironment: "Srodowisko",
  ...
  de: {
    ...
    typeFiveSImprovement: "5S-Verbesserung",
    typeImprovementSuggestion: "Verbesserungsvorschlag",
    improvementSubtype: "Untertyp",
    selectImprovementSubtype: "Untertyp auswahlen",
    fiveSAreaImprovement: "Bereichsverbesserung",
    fiveSDisorganization: "Unordnung",
    improvementSafety: "Sicherheit",
    improvementHealth: "Gesundheit",
    improvementEnvironment: "Umwelt",
  ...
  ro: {
    ...
    typeFiveSImprovement: "Imbunatatire 5S",
    typeImprovementSuggestion: "Sugestie de imbunatatire",
    improvementSubtype: "Subtip",
    selectImprovementSubtype: "Selectati subtipul",
    fiveSAreaImprovement: "Imbunatatire zona",
    fiveSDisorganization: "Dezorganizare",
    improvementSafety: "Siguranta",
    improvementHealth: "Sanatate",
    improvementEnvironment: "Mediu",
  ...
  fr: {
    ...
    typeFiveSImprovement: "Amelioration 5S",
    typeImprovementSuggestion: "Suggestion d'amelioration",
    improvementSubtype: "Sous-type",
    selectImprovementSubtype: "Selectionner le sous-type",
    fiveSAreaImprovement: "Amelioration de zone",
    fiveSDisorganization: "Desorganisation",
    improvementSafety: "Securite",
    improvementHealth: "Sante",
    improvementEnvironment: "Environnement",
