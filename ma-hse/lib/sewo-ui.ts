...
export const BASE_SEWO_UI = {
  ...
  tableDelete: "Delete",
  editButton: "Edit",
  deleteSewo: "Delete S-EWO",
  deleteSewoConfirmTitle: "Delete S-EWO?",
  deleteSewoImpact: "This draft S-EWO will be removed from the operational list. Its source communication and any safety records remain unchanged, and the deletion is retained in the audit history.",
  deleteSewoCancel: "Cancel",
  deleteSewoSuccess: "S-EWO deleted.",
  deleteSewoError: "Failed to delete S-EWO.",
  deleteSewoNotAllowed: "You do not have permission to delete S-EWO records.",
  deleteSewoDraftOnly: "Only draft S-EWO records can be deleted.",
  deleteSewoLinkedActions: "S-EWO records with linked actions cannot be deleted.",
  ...
  n1ValidationHistorySection: "S-EWO validation history",
  n1ValidationHistoryEmpty: "No S-EWO records have a Corporate decision yet.",
  n1ValidationCreationDate: "S-EWO creation date",
  n1ValidationDecisionDate: "Decision date",
  n1ValidationValidated: "Validated",
  n1ValidationRejected: "Rejected",
  n1ValidationEdit: "Edit",
  n1ValidationShare: "Share",
  n1ValidationShareReport: "Share report",
  n1ValidationShareOnlyValidated: "Only validated S-EWO reports can be shared.",
  n1ValidationShareSaved: "S-EWO report shared.",
  n1ValidationChangeDecision: "Change S-EWO decision",
  n1ValidationCurrentStatus: "Current status",
  n1ValidationNewStatus: "New status",
  n1ValidationDecisionChangeWarning: "The Corporate decision will be modified.",
  n1ValidationConfirm: "Confirm",
  n1ValidationCancel: "Cancel",
  n1ValidationSharePromptTitle: "Share S-EWO report?",
  n1ValidationSharePromptMessage: "Do you want to share this S-EWO report after validation?",
  n1ValidationSharePromptShare: "Share",
  n1ValidationSharePromptDontShare: "Don't share",
